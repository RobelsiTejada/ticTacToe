...
var onUpdateFail = function onUpdateFail(error) {
  console.error(error);
};
...
var onGetGames = function onGetGames(event) {
  event.preventDefault();
  api.index().then(ui.getSuccess).catch(ui.failure);
...
var userEvents = __webpack_require__(6);
...
var checkForWin = function checkForWin() {
  if ($('#box1').hasClass('symX') && $('#box2').hasClass('symX') && $('#box3').hasClass('symX') || $('#box1').hasClass('symX') && $('#box4').hasClass('symX') && $('#box7').hasClass('symX') || $('#box1').hasClass('symX') && $('#box5').hasClass('symX') && $('#box9').hasClass('symX') || $('#box4').hasClass('symX') && $('#box5').hasClass('symX') && $('#box6').hasClass('symX') || $('#box7').hasClass('symX') && $('#box8').hasClass('symX') && $('#box9').hasClass('symX') || $('#box2').hasClass('symX') && $('#box5').hasClass('symX') && $('#box8').hasClass('symX') || $('#box3').hasClass('symX') && $('#box6').hasClass('symX') && $('#box9').hasClass('symX') || $('#box3').hasClass('symX') && $('#box5').hasClass('symX') && $('#box7').hasClass('symX')) {
    winner = 'playerX';
    turnCount = 0;
    ...
    $('.gameBoard').hide();
    $('#xWins').show();
  } else if ($('#box1').hasClass('symO') && $('#box2').hasClass('symO') && $('#box3').hasClass('symO') || $('#box1').hasClass('symO') && $('#box4').hasClass('symO') && $('#box7').hasClass('symO') || $('#box1').hasClass('symO') && $('#box5').hasClass('symO') && $('#box9').hasClass('symO') || $('#box4').hasClass('symO') && $('#box5').hasClass('symO') && $('#box6').hasClass('symO') || $('#box7').hasClass('symO') && $('#box8').hasClass('symO') && $('#box9').hasClass('symO') || $('#box2').hasClass('symO') && $('#box5').hasClass('symO') && $('#box8').hasClass('symO') || $('#box3').hasClass('symO') && $('#box6').hasClass('symO') && $('#box9').hasClass('symO') || $('#box3').hasClass('symO') && $('#box5').hasClass('symO') && $('#box7').hasClass('symO')) {
    winner = 'playerO';
    turnCount = 0;
    console.log(winner + ' has won the game');
    oWinCount++;
...
var addClass = function addClass() {
  if (playerTurn === 'x') {
    if ($(this).hasClass('symO')) {} else {
      if ($(this).hasClass('symX')) {} else {
        $(this).addClass('symX');
        checkForWin();
        turnCount++;
...
// imports
exports.push([module.i, "@import url(//netdna.bootstrapcdn.com/twitter-bootstrap/2.2.2/css/bootstrap-combined.min.css);", ""]);
...
module.exports = __webpack_require__.p + "cde7608b4c19a8fcdca9e24d31d0777d.jpg";

/***/ }),
/* 22 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "a4bcceb2def627447ff7c72410287821.png";

/***/ }),
/* 23 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "57e66fc5672ba783d8cd73c1a0e52833.png";

/***/ }),
/* 24 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "35a467e62e87e51207b2b1545f17e4a6.jpg";
